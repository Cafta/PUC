...
int main() {
    ...
    while (cap.read(frame)) {
        ...
        putText(frame, format("Via Azul: %d", count_azul), Point(20, 40),
                FONT_HERSHEY_SIMPLEX, 1, corBranca, 4);
        putText(frame, format("Via Vermelha: %d", count_Vermelha), Point(20, 80),
                FONT_HERSHEY_SIMPLEX, 1, corBranca, 4);
